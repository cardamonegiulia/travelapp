...
class DenyByDefaultSecurityTest extends SecurityIntegrationTestBase {
    ...
    @CsvSource({
            ...
            "GET,    /api/preferiti/1",
            "PUT,    /api/preferiti/1",
            "DELETE, /api/preferiti/1",
            "POST,   /api/preferiti/1/itinerari",
            "DELETE, /api/preferiti/1/itinerari/1",
            "POST,   /api/preferiti/itinerari",
            "DELETE, /api/preferiti/itinerari/1",
            "POST,   /api/preferiti/1/condivisioni",
            "DELETE, /api/preferiti/1/condivisioni/2",
