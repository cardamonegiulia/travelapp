...
/** Segnaposto della sezione "Bookings", in attesa della UI definitiva. */
@Composable
fun BookingsScreen(modifier: Modifier = Modifier) {
    Scaffold(
        ...
        topBar = { AppTopBar(title = "Bookings") }
    ) { innerPadding ->
        Box(
            ...
            Text(
                text = "Sezione Bookings in arrivo",
                fontSize = 15.sp,
                color = TextSecondary
            )
        }
...
@Preview(showBackground = true, showSystemUi = true, name = "Bookings")
@Composable
